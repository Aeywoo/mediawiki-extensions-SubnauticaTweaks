...
class StopForumSpam {
	...
	private static function doRemoteCall( $query ) {
		...
		wfDebugLog('SubnauticaTweaks', "Making request to SFS API with URL: {$url}");
		...
		wfDebugLog( 'SubnauticaTweaks', "SFS lookup for {$url}. Result: {$result}" );
