...
function wfRobotsMain() {
    global $wgSubnauticaTweaksNetworkCentralDB, $wgCanonicalServer, $wgScriptPath, $wgArticlePath, $wgSubnauticaTweaksNoRobots, $wgNamespaceRobotPolicies;

    if ( $wgSubnauticaTweaksNoRobots ) {
